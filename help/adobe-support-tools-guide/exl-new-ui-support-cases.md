...
>[!TIP]
>
>Wenn Sie die Option **[!UICONTROL Fall öffnen]** oder die Karte **[!UICONTROL Support-Fall öffnen]** nicht sehen, wenden Sie sich an Ihren Systemadministrator, um die Rolle des Support-Administrators zuzuweisen.
...
- **[!UICONTROL Status]** — wartet auf Zuweisung, wird ausgeführt, Problem überholt, Lösung bestätigt, Lösung irrelevant
