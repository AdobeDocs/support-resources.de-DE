...
Bereiten Sie das Onboarding Ihres Unternehmens für die Adobe Admin Console vor [Migrations-Checkliste](https://experienceleague.adobe.com/docs/workfront/using/administration-and-setup/admin-in-admin-console/prep-for-admin-console.html):
