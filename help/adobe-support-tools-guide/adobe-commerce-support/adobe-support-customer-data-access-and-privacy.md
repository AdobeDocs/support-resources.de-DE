...
1. Vergewissern Sie sich auf der **[!UICONTROL Mein Konto]** Seite > **[!UICONTROL Kontoeinstellungen]**, dass Sie Ihr [Kontoprofil](https://account.magento.com/customer/account/edit) ausgefüllt haben, und klicken Sie auf **[!UICONTROL Speichern]**.
1. Auf der Seite **[!UICONTROL Mein Konto]** > **[!UICONTROL Kontoeinstellungen]** > **[!UICONTROL Datenschutzeinstellungen]**. Sie sehen ein Einverständnisformular, um Mitarbeitern des technischen Supports von Adobe Zugriff auf Ihre Daten zu gewähren.
...
1. Wählen Sie in der Dropdown-Liste Dauer den Zeitraum aus, über den die Mitarbeiter des technischen Supports von Adobe Zugriff auf Ihre Kundendaten haben sollen. Sie können 7 Tage, 30 Tage, ein Jahr oder unbegrenzt auswählen.
1. Klicken Sie auf **[!UICONTROL Speichern]**. Dadurch werden das Start- und Enddatum unten auf der Seite unter &quot;**haben Ihr Einverständnis für die folgende Dauer erteilt** (Screenshot) aktualisiert. Nachdem das Einverständnis erteilt wurde, wird dem berechtigten primären Benutzer am unteren Bildschirmrand die Option zum Widerrufen des Einverständnisses angezeigt.
   ![magento-account-privacy-settings.png](/help/adobe-support-tools-guide/assets/magento-account-privacy-settings.png)

Sie können jederzeit auf **Einverständnis widerrufen** klicken, um Ihre Einwilligung für den Zugriff des Adobe-Supportpersonals auf Ihre Daten zu widerrufen.
