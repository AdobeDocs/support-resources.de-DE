...
>
>Bei Problemen mit der Veröffentlichung Ihrer Erweiterung, Problemen beim Kauf oder der Anforderung einer Rückerstattung auf dem [Adobe Commerce Marketplace](https://commercemarketplace.adobe.com/) müssen Sie sich direkt an das [!DNL Commerce Marketplace] wenden, indem Sie https://commercemarketplace.adobe.com/ besuchen. Navigieren Sie zum unteren Rand der Seite und klicken Sie auf **[!UICONTROL Kontakt]**, um ein Formular zum Senden eines Marketplace-Support-Tickets zu öffnen.
...
>1. Wenn Sie die Anfrage für OrgA-Product1 eingereicht haben und in Zukunft **[!UICONTROL Meine Anfragen]** für diese Organisation überprüfen möchten, wird diese nicht angezeigt, wenn Sie OrgA-Product2 als Organisation auswählen (Sie müssen nur die andere Organisation im Vergleich zu Beispiel B auswählen).
>
>**Beispiel B**: Sie haben gemeinsamen Zugriff auf zwei Unternehmen, und jede Firma hat nur Berechtigungen für Adobe Commerce.
>
>1. Wenn Sie den Fall für OrgA eingereicht haben, das Problem aber tatsächlich Auswirkungen auf OrgB hat, können Mitglieder der OrgB diesen Fall in Zukunft nicht mehr unter **[!UICONTROL Meine Fälle]** sehen.
>1. Darüber hinaus können Mitglieder von OrgA Fälle unter &quot;**[!UICONTROL Fälle“ sehen]** die tatsächlich für OrgB vorgesehen sind, was zu Datenschutzproblemen führen kann.
...
Sie können die von Ihnen übermittelten Commerce-Anfragen anzeigen, indem Sie **[!UICONTROL Menü links auf]** Meine Anfragen“ klicken. Stellen Sie sicher, dass Sie die richtige Organisation mit der Endung „(Commerce)“ ausgewählt haben.
...
Um Fälle zu finden, geben Sie Ihre Suchanfrage in das Feld *[!UICONTROL Suche]* ein und drücken Sie die *Eingabetaste* auf Ihrer Tastatur.
...
1. Nach dem Klicken wird ein Popup-Formular angezeigt. Füllen Sie das Formular aus und klicken Sie dann auf **[!UICONTROL Eskalieren]**.
...
1. Geben Sie den Kommentar in das Feld **[!UICONTROL Kommentare]** ein und klicken Sie auf **[!UICONTROL Kommentare hinzufügen]**.

![Kommentare hinzufügen](/help/adobe-support-tools-guide/assets/add_comments.png)

### Fall schließen {#close-case}

Um Ihren Fall zu schließen, klicken Sie **[!UICONTROL Fall schließen]** unten rechts im Bedienfeld *[!UICONTROL Falldetails]*.

![Groß-/Kleinschreibung](/help/adobe-support-tools-guide/assets/close_case.png)
...
>[!NOTE]
>
>Sie können einen Fall nicht erneut öffnen, indem Sie auf eine E-Mail-Benachrichtigung von einem geschlossenen Ticket antworten. Um den Fall erneut zu öffnen, stellen Sie sicher, dass Sie vom Kontoinhaber [Freigegebenen Zugriff](https://experienceleague.adobe.com/de/docs/experience-cloud-kcs/kbarticles/ka-26164) erhalten haben.
...
1. Suchen Sie den Benutzer, für den Sie den freigegebenen Zugriff widerrufen möchten, und klicken Sie ![Symbol entfernen](/help/adobe-support-tools-guide/assets/remove_icon.png){width="25"} in der Zeile des Benutzers (**Aktionen** Spalte).
...
Wenn Sie ein Adobe Commerce Cloud-Projekt haben/hatten und eine Benutzerin oder einen Benutzer zum Projekt hinzugefügt haben, wurde ihr bzw. ihm möglicherweise automatisch gemeinsamer Zugriff auf die Bild-ID des Projektbesitzers gewährt. Dies wird normalerweise in der Spalte **[!UICONTROL Freigabename]** angezeigt, die *Freigegebenen Cloud-Zugriff von MAG[XYZ]* anzeigt.
...
1. Melden Sie sich bei Ihrem Adobe Commerce-Konto unter [https://account.magento.com](https://account.magento.com/) an.
1. Wählen Sie im Bedienfeld links unter **[!UICONTROL Freigegebener Zugriff]** die Option **[!UICONTROL Berechtigungen verwalten]** aus.
1. Suchen Sie den Benutzer, für den Sie den freigegebenen Zugriff widerrufen möchten, und klicken Sie **[!UICONTROL Bearbeiten]** in der Zeile des Benutzers (Spalte *[!UICONTROL Aktionen]*).
1. Deaktivieren Sie alle Ressourcen unter **[!UICONTROL Kontoberechtigungen erteilen]**.
1. Um Verwirrung darüber zu vermeiden, ob der Benutzer immer noch über **[!UICONTROL Cloud Shared Access]** verfügt, sollten Sie den **[!UICONTROL Freigabenamen]** in einen Namen ändern, wie zum Beispiel: *Cloud Shared Access Revocked - Can&#39;t be deleted* oder etwas Ähnliches.
