...
- [Beheben von Federated ID-Fehlern](https://helpx.adobe.com/enterprise/kb/tshoot-fed-id.html)
...
- [Lizenzen Team-Benutzern zuweisen](https://helpx.adobe.com/enterprise/using/assign-licenses-to-teams-users.html)
