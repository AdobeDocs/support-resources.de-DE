...
- [Übernahme der globalen Verwaltung](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)
...
- [Verwalten von Benutzergruppen](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-user-groups)
...
- [Aktivieren/Deaktivieren von Diensten](https://helpx.adobe.com/enterprise/using/enable-disable-services.html)
