...
- Pflegen Sie den täglichen Betrieb, während Systemadministratoren weiterhin ihre eigenen Admin Consoles verwalten. Ein globaler Administrator kann beispielsweise ein Produkt einer untergeordneten Admin Console zuweisen, es jedoch nicht Benutzern zuweisen. Der Systemadministrator erhält die Lizenzen in seinem Admin Console und weist die Produkte seinen Benutzern zu.
...
1. Wählen Sie **[!UICONTROL Admin hinzufügen]** aus.
   ...
   ![Globale Admin Console - Admin hinzufügen](../assets/global-admin-console-add-admin.png)
...
1. Wählen Sie im Abschnitt „Administratorrechte“ mindestens **[!UICONTROL Administratorrollen]**.
   ...
   ![Globale Admin Console - Admin hinzufügen](../assets/global-admin-console-add-admin-detail.png)
...
Nachdem der Administrator hinzugefügt wurde, erhält er eine E-Mail-Nachricht, in der er aufgefordert wird, seine Rolle zu akzeptieren, und über die er einen Link zur Admin Console erhält. Wenn sie sowohl als globaler Administrator als auch in einer anderen Rolle hinzugefügt werden, erhalten sie zwei Einladungen, eine zur globalen Admin Console und eine zur Admin Console.
...
1. Wählen Sie das Symbol **[!UICONTROL Weitere Optionen]** (⋮) für den entsprechenden Administrator und dann **[!UICONTROL Admin bearbeiten]**.
   ...
   ![Globale Admin Console - Administratorrechte bearbeiten](../assets/global-admin-console-edit-admin-right.png)
...
1. Wählen Sie das Symbol **[!UICONTROL Weitere Optionen]** (⋮) für den entsprechenden Administrator und dann **[!UICONTROL Administratorrechte entfernen]**.
   ...
   ![Globale Admin Console - Administratorrechte entfernen](../assets/global-admin-console-remove-admin-right.png)
