...
- [Verwalten von Produktprofilen](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-product-profiles)
...
Mithilfe [Konsoleneinstellungen](https://helpx.adobe.com/enterprise/using/console-settings.html) können Sie Ihren Endbenutzern benutzerdefinierte Notizen hinzufügen, um mit ihnen darüber zu kommunizieren, wie sie Hilfe erhalten, wenn Probleme auftreten oder Unterstützung benötigt wird.
...
Als Administrator können Sie detaillierte Berichte über die Arbeit der Endbenutzer mit Unternehmens-Assets wie Ordnern, Dateien und Bibliotheken herunterladen. Diese Berichte werden als [Inhaltsprotokolle“ &#x200B;](https://helpx.adobe.com/enterprise/using/content-logs.html).
