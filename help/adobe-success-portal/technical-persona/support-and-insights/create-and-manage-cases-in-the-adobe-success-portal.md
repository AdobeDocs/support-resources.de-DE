...
1. Wählen Sie **[!UICONTROL Fall öffnen]** aus.
   ...
   ![Schaltfläche „Fall öffnen“ im Abschnitt zum Erstellen eines neuen Falls im Adobe Success-Portal](../../assets/adobe-success-portal-home-page-open-case.png "Schaltfläche „Fall öffnen“")
...
1. Wählen Sie **[!UICONTROL Fall senden]** aus.
   ...
   ![Schaltfläche „Fall senden“ unten im Support-Ticket-Formular im Adobe Success-Portal](../../assets/adobe-success-portal-submit-case.png "Support-Anfrage senden")
...
1. Wählen Sie **[!UICONTROL Fall öffnen]** aus.
   ...
   ![Schaltfläche „Fall öffnen“ im Abschnitt zum Erstellen eines neuen Falls im Adobe Success-Portal](../../assets/adobe-success-portal-support-insights-open-case.png "Schaltfläche „Fall öffnen“")
...
1. Wählen Sie die Produktkarte aus, die Sie anzeigen möchten, und wählen Sie dann **[!UICONTROL Offene Fälle]** oder **[!UICONTROL Geschlossene Fälle]** aus.
   ...
   ![Indikatoren für offene und geschlossene Fälle im Abschnitt „Support und Erkenntnisse“ für AEM Cloud Service – Assets](../../assets/adobe-success-portal-open-case-closed-case.png "Zusammenfassung offener und geschlossener Support-Fälle anzeigen")
...
1. Klicken Sie auf **[!UICONTROL Fallnummer]**, um die Falldetails anzuzeigen.
   ...
   ![Link „Fallnummer“ in den Support-Fällen im Adobe Success-Portal](../../assets/adobe-success-portal-case-number.png "Zum Anzeigen der Falldetails klicken")
...
1. Aktivieren Sie auf der Seite [Produkt – Support-Fälle] das Kontrollkästchen neben dem Fall, den Sie herunterladen möchten, und wählen Sie **[!UICONTROL Fälle herunterladen]** aus.
   ...
   ![Schaltfläche „Fälle herunterladen“ im Abschnitt „Fall-Management“ im Adobe Success-Portal](../../assets/adobe-success-portal-download-cases.png "Daten zu Support-Fällen herunterladen")
